...
# For details on these fields, see https://wiki.theory.org/BitTorrentSpecification.
...
def check_info(info):
    """Validate the metainfo data, also known as the torrent file."""
